...
import { SECURED_GIFTS_ADDRESS, TOKEN_ADDRESSES } from '@/lib/constants';
import type { TokenType } from '@/lib/types';
import { SECURED_GIFTS_ABI, ERC20_ABI } from '@/abi/KeyRegistry';
  ...
  const handleSend = async () => {
    try {
      ...
      try {
        ...
        const contract = new ethers.Contract(SECURED_GIFTS_ADDRESS, SECURED_GIFTS_ABI, signer);
        ...
        if (selectedToken === 'ETH') {
          ...
          const approveTx = await tokenContract.approve(SECURED_GIFTS_ADDRESS, value);
