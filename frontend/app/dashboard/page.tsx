...
import { SECURED_GIFTS_ADDRESS } from '@/lib/constants';
import { SECURED_GIFTS_ABI } from '@/abi/KeyRegistry';
  ...
  useEffect(() => {
    const pollEvents = async () => {
      try {
        ...
        const contract = new ethers.Contract(SECURED_GIFTS_ADDRESS, SECURED_GIFTS_ABI, provider);
